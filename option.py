...
class options():    
    ...
    def get_opt(self):
        ...
        parser.add_argument("--day", type=int, default=day, help="The starting day of the week.")
        parser.add_argument("--month", type=int, default=month, help="The starting day of the week.")
